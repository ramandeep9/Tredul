...
const people = [
  {
    name: 'Dr.Thakur Sudesh Kumar Ranauja (Director DHE)',
        ...
        <div className="big_container">
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-4">
                <div className="thumbnail">
                  ...
                  <div className="caption">
                    <p className="Top_eduH">
                      Dr. Thakur Sudesh Kumar Raunija <br/>-Director DHE
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="thumbnail">
                  <img className="my" alt="location" src={IIT} />
                  <div className="caption">
                    <p className="Top_eduH">
                       Prof. Rajeev Ahuja <br/>-Director IIT Ropar
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="thumbnail">
                  <img className="my" alt="location" src={NitJ} />
                  <div className="caption">
                    <p className="Top_eduH">
                    Prof. Binod Kumar Kanaujia <br/>-Director NIT Jalandhar
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="thumbnail">
                  ...
                  <div className="caption">
                    <p className="Top_eduH">
                    Prof. B.V. Ramana Reddy <br/>-Director NIT Kurukshetra
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="thumbnail">
                  <img className="my" alt="location" src={CU} />
                  <div className="caption">
                    <p className="Top_eduH">
                      Prof.Jagbir Singh<br/>-Chancellor CU Punjab 
                    </p>
                  </div>
                </div>
              </div>
